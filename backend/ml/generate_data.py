...
def generate_student_career_data(n_rows: int = 1500, out_path: str = "data/student_career.csv"):
    ...
    cities = ["Delhi", "Lucknow", "Noida", "Bangalore", "Pune", "Hyderabad", "Jaipur", "Bhopal", "Patna", "Kolkata"]
    ...
    for _ in range(n_rows):
        ...
        # Skills: better marks -> slightly higher chance of more skills
        ...
        # Career decision logic (realistic-ish)
        ...
        # Salary (LPA) logic by career + marks + skills
        base_salary_map = {
            "AI / Data Science": 7.0,
        ...
        marks_boost = (avg - 60) * 0.12  # avg 80 -> +2.4 approx
